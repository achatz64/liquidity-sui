...
import { ConfigManagerKriya, PoolManagerKriya } from "../src/dexes/kriya/pool_manager";

const example_config_kriya: ConfigManagerKriya = {
    dex: Dex.Kriya,
    kriya_api_wait_ms: 3 * 1000,
...
const pool_manager = new PoolManagerKriya(example_config_kriya);
